...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "Ca_ion");
 	...
 	ivoc_help("help ?1 cat /home/arsentii/hippocalcin/HPCA-CA1/mechanism/cat.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/arsentii/hippocalcin/HPCA-CA1/mechanism/cat.mod";
static const char* nmodl_file_text = 
  ...
  "	ki = 0.001    (mM)\n"
  "	cai = 100e-5   (mM)       : initial internal Ca++ concentration\n"
